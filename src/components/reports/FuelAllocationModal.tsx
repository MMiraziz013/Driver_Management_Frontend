...
export function FuelAllocationModal({ isOpen, onClose, periodId }: FuelAllocationModalProps) {
    ...
    const fetchAllocationData = async () => {
        ...
        try {
            const response = await fetch(`${API_BASE}/fuel/status/${periodId}`);
    ...
    const handleRunAllocation = async () => {
        ...
        try {
            const response = await fetch(`${API_BASE}/fuel/allocate/${periodId}`, {
                method: 'POST'
            });
    ...
    const handleDownloadReport = async () => {
        try {
            const response = await fetch(`${API_BASE}/fuel/export/${periodId}`);
